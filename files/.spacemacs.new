...
This function should only modify configuration layer settings."
  (setq-default
   ...
   ;; with a supported type is opened). Possible values are `all', `unusedp
...
(defun two-spaces ()
  (interactive)
  (message "setting indents to two spaces")
  (my-setup-indent 2)
  )
...
before packages are loaded."
  ...
  (setq-default dotspacemacs-excluded-packages '(emmet-mode alchemist))
  ...
  ;; Set up elixir layer with elixir-ls
  ;; START @mosic copy
  ...
  (add-to-list 'spacemacs-indent-sensitive-modes 'asn1-mode)
  ...
  (global-set-key (kbd "C-l") 'helm-projectile-find-file)
  ...
  (evil-leader/set-key "bo" 'spacemacs/kill-other-buffers)
  ...
  (define-key evil-insert-state-map (kbd "TAB") 'tab-to-tab-stop)
  ;; enable company mode for everything
  (global-company-mode)
  ;; open asn1 files using the right mode
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (vimrc-mode dactyl-mode alchemist lsp-ui company-lsp lsp-mode ht counsel-css typit mmt sudoku pacmacs 2048-game yapfify stickyfunc-enhance pytest pyenv-mode py-isort pippel pipenv pyvenv pip-requirements live-py-mode importmagic epc ctable concurrent deferred helm-pydoc helm-cscope xcscope cython-mode company-anaconda anaconda-mode pythonic company-terraform terraform-mode hcl-mode web-mode tagedit slim-mode scss-mode sass-mode pug-mode less-css-mode helm-css-scss haml-mode emmet-mode company-web web-completion-data sql-indent erlang neotree yasnippet-snippets yaml-mode smeargle seti-theme ob-elixir org-plus-contrib mmm-mode markdown-toc markdown-mode magit-svn magit-gitflow jinja2-mode insert-shebang helm-gitignore request helm-git-grep helm-company helm-c-yasnippet gitignore-templates gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter gh-md fuzzy flycheck-mix flycheck-credo flycheck-bashate fish-mode evil-magit magit transient git-commit with-editor dockerfile-mode docker tablist magit-popup docker-tramp diff-hl company-tern dash-functional company-statistics company-shell company-ansible browse-at-remote auto-yasnippet asn1-mode ansible-doc ansible elixir-mode ac-ispell auto-complete web-beautify tern prettier-js livid-mode skewer-mode js2-refactor yasnippet multiple-cursors js2-mode js-doc impatient-mode htmlize simple-httpd helm-gtags ggtags flycheck evil-matchit counsel-gtags counsel swiper ivy company add-node-modules-path which-key use-package treemacs-projectile treemacs-evil pcre2el overseer nameless macrostep helm-xref helm-themes helm-swoop helm-projectile helm-mode-manager helm-make helm-flx helm-descbinds helm-ag evil-mc elisp-slime-nav dotenv-mode diminish bind-map auto-compile ace-jump-helm-line))))
(custom-set-faces
